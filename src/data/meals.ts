...
export const meals: Meal[] = [
  ...
  },
  {
    ...
    imageUrl: "https://production.streetkitchen-cdn.com/szekelykaposzta-3-d2g6j4.webp",
    recipeUrl: "https://streetkitchen.hu/receptek/igy-keszul-a-tokeletes-szekelykaposzta",
    content: `[Myślę, że bekon jest opcjonalny] Podsmaż pokrojony w drobną kostkę boczek i podsmaż na nim mięsisty boczek. Możesz również dodać drobno posiekaną czerwoną cebulę i zmiażdżony czosnek.\n\nDolej odrobinę wody i posyp czerwoną papryką. Dodaj sól i dopraw pozostałymi przyprawami, a następnie gotuj bazę przez pół godziny, kilkakrotnie dolewając odrobinę wody…\n\nDodaj pokrojone w kostkę mięso, a po 10 minutach kapustę, którą możesz wcześniej opłukać, jeśli uznasz ją za zbyt kwaśną.\n\nGotuj do miękkości mięsa, a następnie podawaj ze śmietaną.`,
    ingredients: [
      { name: "Kapusta kiszona (sauerkraut)", quantity: 1000, unit: "g" },
      { name: "Noga wieprzowa (pork leg)", quantity: 700, unit: "g" },
      { name: "Wędzony boczek (smoked bacon)", quantity: 100, unit: "g" },
      { name: "Transylwański bekon mięsny", quantity: 100, unit: "g" },
      { name: "Cebula (onion)", quantity: 3, unit: "szt" },
      { name: "Czosnek (garlic)", quantity: 6, unit: "ząbki" },
      { name: "Papryka mielona (ground paprika)", quantity: 2, unit: "łyżeczka" },
      { name: "Pieprz mielony (ground pepper)", quantity: 1, unit: "łyżeczka" },
      { name: "Sól (salt)", quantity: 2, unit: "g" },
      { name: "Majeranek (majoránna)", quantity: 1, unit: "łyżeczka" },
